...
/*
const float a0 = 0.01140365734040795;
const float a1 = 0.0228073146808159;
const float a2 = 0.01140365734040795;
const float b1 = -1.0855666854380697;
const float b2 = 0.13118131479970135;
*/
const int32_t a0 = 0.01140365734040795*100000;
const int32_t a1 = 0.0228073146808159*100000;
const int32_t a2 = 0.01140365734040795*100000;
const int32_t b1 = -1.0855666854380697*100000;
const int32_t b2 = 0.13118131479970135*100000;

int32_t z1 = 0, z2 = 0;		

int8_t lpf(int8_t value)
{
			
		int32_t w,out;

    w = (float)value - b1*z1 - b2*z2;
...
ISR(TIMER0_COMPA_vect, ISR_BLOCK)
{
	...
	if (Audio_Device_IsSampleReceived(&Speaker_Audio_Interface))
	{
		...
		OCR3A = LeftSample_8Bit + 128;
		OCR3B = RightSample_8Bit + 128;


		//OCR1A =  208 + (LeftSample_8Bit)/16;
		//if(TCNT1 > OCR1A) TCNT1 = OCR1A-10;
